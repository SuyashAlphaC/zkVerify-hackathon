...
contract DSCEngine is ReentrancyGuard {
    ...
    function depositCollateralAndMintDsc(
        ...
        mintDsc(amountDscToMint, _hash, _attestationId, _merklePath, _leafCount, _index);
    }
    ...
    * @notice: A known bug would be if the protocol was only 100% collateralized, we wouldn't be able to liquidate
    ...
    function liquidate(
        ...
        uint256 startingUserHealthFactor = _healthFactor(user, _hash, _attestationId, _merklePath, _leafCount, _index);
        ...
        uint256 endingUserHealthFactor = _healthFactor(user, _hash, _attestationId, _merklePath, _leafCount, _index);
    ...
    function _healthFactor(
        ...
        return _calculateHealthFactor(
            totalDscMinted, collateralValueInUsd, _hash, _attestationId, _merklePath, _leafCount, _index
        );
    }
    ...
    function _calculateHealthFactor(
        ...
        // Verify the zkProof before calculating the health factor
        _verifyHealthFactorProof(_hash, _attestationId, _merklePath, _leafCount, _index);
    ...
    function getLeaf() external view returns (bytes32) {
        return keccak256(
            abi.encodePacked(
                ...
                keccak256(
                    abi.encodePacked(
                        "0xaaaaaaaa8a1cf307bba3c5a0e1bf0614000040bd8b5b936b6c000000000000000c000000000000000000000000000000"
                    )
                )
            )
        );
    ...
    function revertIfHealthFactorIsBroken(
        ...
        uint256 userHealthFactor = _healthFactor(user, _hash, _attestationId, _merklePath, _leafCount, _index);
    ...
    function getHealthFactor(
        ...
        return _healthFactor(user, _hash, _attestationId, _merklePath, _leafCount, _index);
    }
}
